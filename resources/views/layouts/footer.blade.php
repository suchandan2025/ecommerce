                            ...
                            <div class="footer-widget about-widget">
                                ...
                                <ul class="contact-list">
                                    ...
                                    <li>
                                        ...
                                        <a href="/cdn-cgi/l/email-protection#77191212131f121b073714181a0716190e5914181a"><span class="__cf_email__" data-cfemail="a0cec5c5c4c8c5ccd0e0c3cfcdd0c1ced98ec3cfcd">[email&#160;protected]</span></a>
                                    </li>
                                    <li>
                                        <i class="fa fa-map-marker"></i> 666 road, broklyn street new york
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="footer-widget gallery-widget">
                                ...
                                <div class="widget-content">
                                    <div class="outer clearfix">
                                        <figure class="image">
                                            <a href="{{asset('assets/images/gallery/1.jpg')}}" class="lightbox-image" title="Image Title Here"><img
												src="{{asset('assets/images/resource/insta-1.jpg')}}" alt=""></a>
                                        </figure>

                                        <figure class="image">
                                            <a href="{{asset('assets/images/gallery/2.jpg')}}" class="lightbox-image" title="Image Title Here"><img
												src="{{asset('assets/images/resource/insta-2.jpg')}}" alt=""></a>
                                        </figure>

                                        <figure class="image">
                                            <a href="{{asset('assets/images/gallery/3.jpg')}}" class="lightbox-image" title="Image Title Here"><img
												src="{{asset('assets/images/resource/insta-3.jpg')}}" alt=""></a>
                                        </figure>

                                        <figure class="image">
                                            <a href="{{ asset('assets/images/gallery/4.jpg') }}" class="lightbox-image" title="Image Title Here"><img
												src="{{ asset('assets/images/resource/insta-4.jpg') }}" alt=""></a>
                                        </figure>

                                        <figure class="image">
                                            <a href="{{ ('images/gallery/5.jpg') }}" class="lightbox-image" title="Image Title Here"><img
												src="{{ asset('assets/images/resource/insta-5.jpg') }}" alt=""></a>
                                        </figure>

                                        <figure class="image">
                                            <a href="{{ asset('assets/images/gallery/1.jpg') }}" class="lightbox-image" title="Image Title Here"><img
												src="{{ asset('assets/images/resource/insta-6.jpg') }}" alt=""></a>
                                        </figure>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="auto-container">
                    <div class="inner-container">
                        <div class="copyright-text">
                            <p style="color: #000000;">© Copyright Reserved 2025 IRS Design  <a href="index.html" style="color: #000000;"> — Design, Development & Digital Marketing</a></p>
                        </div>
                    </div>
                </div>
            </div>
